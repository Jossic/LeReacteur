...
// Get a Movie
router.get('/movies/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.delete('/movies', permissionMiddlewareCreator.delete(), (request, response, next) => {
